...
| Different ML technique family from team project | Supervised XGBoost regression; team project uses different ML technique family (confirmed separately per MGMT655 instructions) | Met (see declaration below) |
